...
class NAtSLayerCache:
    ...
    def update(self,
        ...
        if pad_size > 0:
            ...
            # self.cache_idx = F.pad(self.cache_idx, (0, 0, 0, pad_size))
        ...
        # self.cache_idx[:, :, self.n_ctx_data:score_size] = cache_idx.to(self.cache_idx)
    ...
    def _post_update(self, x_len):
        ...
        if x_len == 1 and self.update_chunk_size == 1:
            ...
            # size_update_local = (self.size_local_kv + 1) * is_global_tokens
    ...
    def move_sliding_window_tokens_to_head(self, x_len: int):
        ...
        # self.cache_idx[:, :, fill_indices] = self.cache_idx[:, :,
        #                                     self.n_ctx_data - x_sliding_window_tokens: self.n_ctx_data]
        return
